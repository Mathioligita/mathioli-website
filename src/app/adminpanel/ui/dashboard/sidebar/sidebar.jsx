...
//   const pathname = window.location.pathname.split("/")[3]; // Get current pathname
//   const [isOpen, setIsOpen] = useState(false);
//   // console.log(pathname.split("/")[2], "pathame");
//   const model = [
//     {
//       label: "Home",
//       items: [
...
//                   const isActive = pathname === item.to.split("/")[3]; // Check if the current route matches
//                   return (
//                     <a
//                       href={item.to}
//                       className={`p-ripple ${isActive ? "active" : ""}`} // Apply active class
//                       key={subIndex}
//                     >
