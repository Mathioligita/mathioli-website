...
export default function Quote() {
		...
		return (
			<div className="quote-container">
				<div className="quote-card active">
					...
					<div className="author text-end me-4" style={{ position: 'fixed', right: '0' }}>
						- Mathioli Gita
					</div>
				</div>
			</div>
	...
	return (
		<div className="quote-container">
			<div className="quote-card active">
				<div className="slider-header">Today’s Quote</div>
				<div className="quote mt-3" style={{ position: 'relative' }}>
					{item[currentIndex]?.quote}
				</div>
				<div className="author text-end me-4 mt-4" style={{ position: 'fixed', right: '0' }}>
			...
			<div className="dots-container">
				{item.map((_, index) => (
					<div key={index} className={`dot ${index === activeDot ? 'active' : ''}`}></div>
				))}
			</div>
		</div>
	);
