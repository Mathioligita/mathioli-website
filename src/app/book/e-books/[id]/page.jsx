...
// // //       try {
// // //         const response = await booksId(id);
...
// // //           <h1 className="book-title">{datas?.book?.title}</h1>
// // //           <p className="book-info">
// // //             <strong>by {datas?.book?.author}</strong>
// // //           </p>
// // //           <p className="book-info">Ebook</p>
// // //           <p className="book-info">
// // //             ${datas?.book?.price} ({datas?.book?.quantity} copies available)
// // //           </p>
// // //           <p className="book-info">{datas?.book?.description}</p>
// // //         </div>
// // //         <div className="episodes-container">
// // //           {datas?.book?.EbookUpload?.map((pdfFile, index) => (
// // //             <button
// // //               key={index}
// // //               className="episode-button"
// // //               onClick={() => openModal(pdfFile)}
// // //             >
// // //               Chapter {index + 1}
// // //             </button>
// // //           ))}
...
// //   // Customizing toolbar to remove download, print, and export options
  // const defaultLayoutPluginInstance = defaultLayoutPlugin({
...
//     return <div className="error-message">Error: {error}</div>;
//   }
//   const newimage = datas?.book?.bookimage[0];
//   return (
//     <div className="book-page">
//       <div
...
//           backgroundSize: "cover", // Adjust size to cover the entire area
//           backgroundPosition: "center", // Center the image
//           backgroundRepeat: "no-repeat",
//         }}
//       >
//         <div className="book-details text-start">
//           <h1 className="book-title">{datas?.book?.title}</h1>
//           <p className="book-info">
//             <strong>by {datas?.book?.author}</strong>
//           </p>
...
//             <span
//               key={index}
//               className="episode-button  bg-black"
//               onClick={() => openModal(pdfFile)}
//             >
//               Chapter {index + 1}
//             </span>
...
//                   />
//                 </Worker> */}
//                 {/* <div class="_df_book" id="flipbok_example" source={`${selectedPdf}`}></div> */}

//                 {/* <iframe
//                   src={`http://flowpaper.com/flipbook/https://${selectedPdf}`}
//                   width="70%"
//                   height="800"
//                   style={{border:"none"}}
//                   allowFullScreen
