    ...
    <div className="checkout-page">
            ...
            {/* {cartItems?.map((item, index) => (
              <Col md={12} key={index}>
                <div className="d-flex checkout-all">
                  <div>
                    <div className="item-image-container m-2">
                      <img src={item.bookId.bookimage[0]} alt={item.bookId.title} style={{ width: "50px" }} />
                      <Badge value={item.quantity} className="item-image-badge"></Badge>
                    </div>
                    {item.bookId.title}
                  </div>
                  <div className="item-details">
      ...
      <div className="checkout-form p-4">
        <div className="p-grid p-fluid">
          ...
          {console.log(
            states?.stateNames?.map((s) => ({ label: s, value: s }))
          )}
          {/* State Dropdown */}
          <Row className="mb-3">
            <Col md={6}>
