...
// import FormatSelectionModal from "../FormatSelectionModal"; // Import the new modal component
...
//                 <div
//                   className="book-description mt-2 fw-bold"
...
//                 </div>
//               </div>
//               <div className="book-pages d-flex">
//                 <Button
...
//                     }}
//                   >
//                     <i className="pi pi-headphones ms-1 fw-bold"></i>
//                   </Button>
//                 )}
//               </div>
//             </div>
            ...
            <div className="ms-5 book-title">
              ...
              <div className="book-btp mt-4 mb-2">
                <Button
                  ...
                  outlined
                >
                  {/* <div className="book-description fw-bold" >
                  <span className="">
                    <img src="/image/review.png" alt="review" />
                    <i className="pi pi-comments"></i>
                  </span>
                  <br />
                  <div className="p">Review</div>
                </div> */}
                </Button>
              </div>
              ...
              >
                ...
                <div className="d-flex">
                  ...
                  >
                    {/* {isFavorite ? ( */}
                    <FaHeart
                      className={`${isFavorite ? "fav-icon-fill" : "fav-icon"}`}
                      style={{ color: "red" }}
                    />
                    {/* ) : (
