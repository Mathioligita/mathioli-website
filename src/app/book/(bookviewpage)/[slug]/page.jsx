...
import { CartADDAPI, Favoriteadd, FavoriteAPI, SingleBuyProduct } from '../../../../../api/page';
...
export default function BookDetailPage() {
	...
	const { wishlistvalues, setCart, setwishlistvalues, loginpoup } = useContext(userContext);
	...
	return (
		<div className="p-3">
			...
			{showEbook && <PdfViewer setShowebook={setShowebook} ebookSrc={bookDetails.book} />}
