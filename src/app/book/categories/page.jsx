...
export const metadata = {
  title: "Sell new books online",
  description:
    "Buy brand new books online at the best prices. Explore the latest collections in fiction, non-fictions, and more. Fast delivery & secure payment!",
  keywords:
    "Sell new books online,best place to buy books in chennai,chennai best book shops,chennai famous book shops,famous book shops in chennai,famous book stores in chennai,famous bookstores in chennai",
};
