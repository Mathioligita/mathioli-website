    ...
    <div className="mt-4">
      ...
      <div className="container mt-4" style={{ fontFamily: "Poppins" }}>
        <p>
          ...
          including browsing, purchasing products, and interacting with our
        ...
        <ul>
          ...
          <li>
            The content, products, and services provided on this website are for
        ...
        <ul>
          ...
          <li>
            All products are subject to availability. In the event a product is
            out of stock, we will notify you and provide alternatives or a
            refund.
          </li>
        </ul>
        ...
        <ul>
          <li>
            ...
            reserve the right to accept or decline your order at our sole
            discretion.
          </li>
          <li>
        ...
        <ul>
          <li>
            We aim to dispatch orders within the estimated time frame mentioned
            on the website. However, delays may occur due to unforeseen
            circumstances.
          </li>
          <li>
          ...
          <li>
            Once an order is dispatched, we are not liable for delays caused by
            courier services.
          </li>
        </ul>
        ...
        <ul>
          <li>
            Orders can be canceled before they are dispatched by contacting our
          ...
          <li>
            Refunds will be processed for eligible returns within [Insert Refund
            Timeframe] days. The amount will be credited to the original payment
            method.
          </li>
        </ul>
        ...
        <ul>
          <li>
            Mathioli Gita is not liable for any direct, indirect, incidental, or
