    ...
    <div className="sidebar">
      ...
      <ul className="list-unstyled p-2 m-auto">
        ...
        <ul className="fw-bold sidebar-values-adjustment">
          <li onClick={() => router.push("/book/topselling/all")}>Books</li>
          <li onClick={() => router.push("/book/e-books")}>E-Books</li>
          <li onClick={() => router.push("/book/audio-books")}>Audio Books</li>
          <li onClick={() => router.push("//book/categories")}>Categories</li>
        </ul>
